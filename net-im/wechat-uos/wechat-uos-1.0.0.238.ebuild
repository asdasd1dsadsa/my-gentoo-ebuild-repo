...
src_install() {
	...
	fperms +x /opt/wechat-uos/crashpad_handler
	fperms +x /opt/wechat-uos/RadiumWMPF/runtime/WeChatAppEx
	fperms +x /opt/wechat-uos/RadiumWMPF/runtime/WeChatAppEx_crashpad_handler
